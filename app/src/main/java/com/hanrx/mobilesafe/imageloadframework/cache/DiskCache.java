...
import com.hanrx.mobilesafe.imageloadframework.disk.DiskLruCache;
import com.hanrx.mobilesafe.imageloadframework.disk.IOUtil;
...
public class DiskCache implements BitmapCache{
    ...
    private void iniDiskCache(Context context) {
        //得到缓存的目录  android/data/data/com.hanrx.mobilesafe.imageloadframework/cache/Image
